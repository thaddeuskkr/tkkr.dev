        ...
        <div className="motion-safe:animate-portrait-enter">
            <div className="motion-safe:animate-portrait-float">
                <div
                    ...
                    className="hero-portrait group/portrait relative mx-auto w-full max-w-92 lg:mr-0"
                >
                    <div
                        aria-hidden="true"
                        className="hero-portrait__frame absolute -inset-2 z-0 rounded-[2rem] border border-primary/15 bg-primary/6 dark:border-primary/10"
                    />
                    <figure className="hero-portrait__media relative z-10 aspect-5/6 overflow-hidden rounded-[1.7rem] border border-border/80 bg-muted shadow-[0_24px_70px_-38px_color-mix(in_oklch,var(--primary)_70%,transparent)] sm:aspect-5/7">
                        <img
                            src="/robin.jpeg"
                        ...
                        />
                        <div aria-hidden="true" className="hero-portrait__glow absolute inset-0" />
                        <div
                            aria-hidden="true"
